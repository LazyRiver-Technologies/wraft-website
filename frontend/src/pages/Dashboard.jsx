    ...
    <div data-testid="dashboard-page" className="min-h-screen bg-[#FAFAFA]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-[#0A0A0A]" style={{ fontFamily: 'Satoshi' }}>Dashboard</h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {stats.map((s, i) => (
            <div key={i} className="bg-white rounded-xl border border-[#E4E4E7] p-5 hover:shadow-sm transition-shadow">
              ...
              <p className="text-2xl font-bold tracking-tight text-[#0A0A0A]" style={{ fontFamily: 'Satoshi' }}>{s.value}</p>
            </div>
          ))}
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-[#E4E4E7] p-12 text-center">
            ...
            <h2 className="text-xl font-bold mb-2" style={{ fontFamily: 'Satoshi' }}>Create Your First Agent</h2>
